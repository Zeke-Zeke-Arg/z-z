        ...
        <div className="container mx-auto flex items-center justify-center md:justify-end md:mr-10 z-10">
          <div className="z-10 relative px-4 py-12 sm:py-16 sm:w-1/2 max-w-[550px] md:mr-14">
            ...
            <p className="text-lg mb-4">
              We are excited to introduce you to our charter company Feeling Air. Fly directly from
              Ezeiza to our lodges, avoiding the hassle of airport layovers. With a Cessna Turbo
              Stationair and a Cessna Grand Caravan EX, we fly you to your destination in style and
              comfort.
            </p>
            <p className="text-lg">
              In addition to flights to and from our lodges, our continued partnership with other
              small jet companies allows us to assist you with all your charter travel needs.
            </p>
          </div>
        </div>
      </div>
