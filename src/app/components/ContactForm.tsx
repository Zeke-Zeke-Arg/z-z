      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-2/3 text-center md:text-left">
            ...
            <div className="text-lg md:text-xl text-text mb-12 max-w-2xl">
          ...
          <form className="w-full md:w-1/3 space-y-4">
            <input
              type="text"
              placeholder={t("Name")}
              className="w-full rounded-md py-3 px-4 bg-background text-text text-sm outline-accent border border-accent focus:ring-2 focus:ring-accent"
            />
            <input
              type="email"
              placeholder={t("Email")}
            ...
            <textarea
              ...
              rows={6}
              className="w-full rounded-md px-4 bg-background text-text text-sm pt-3 outline-accent border border-accent focus:ring-2 focus:ring-accent"
            ></textarea>
            <button
              type="button"
              className="w-full bg-transparent hover:bg-gold text-white font-semibold hover:text-black py-2 px-4 border border-gold hover:border-transparent rounded transition duration-300"
            >
              {t("Send")}
            </button>
          </form>
